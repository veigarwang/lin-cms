...
namespace LinCms.Extensions
{
    public static class CollectionsExtensions
    {
        ...
        public static ISelect<T1, T2> ToPager<T1, T2>(this ISelect<T1, T2> source, PageDto pageDto, out long count)
            ...
            where T2 : class
        {
            return source.Count(out count).Page(count > pageDto.Page * pageDto.Count ? pageDto.Page + 1 : count / pageDto.Count > pageDto.Page ? pageDto.Page : (int)(count / pageDto.Count) + 1, pageDto.Count);
        }
        ...
        {
            return source.Count(out count).Page(count > pageDto.Page * pageDto.Count ? pageDto.Page + 1 : count / pageDto.Count > pageDto.Page ? pageDto.Page : (int)(count / pageDto.Count) + 1, pageDto.Count).ToList();
        }
        ...
        {
            return source.Count(out count).Page(count > pageDto.Page * pageDto.Count ? pageDto.Page + 1 : count / pageDto.Count > pageDto.Page ? pageDto.Page : (int)(count / pageDto.Count) + 1, pageDto.Count).ToListAsync();
        }
        ...
        {
            return source.Count(out count).Page(count > pageDto.Page * pageDto.Count ? pageDto.Page + 1 : count / pageDto.Count > pageDto.Page ? pageDto.Page : (int)(count / pageDto.Count) + 1, pageDto.Count).ToList<TResult>();
        }
