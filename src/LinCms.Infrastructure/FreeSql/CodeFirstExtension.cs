                    ...
                    e.HasData(new List<BaseType>()
                    {
                        ...
                        new BaseType("Encyclopedia.Type","词条类型",3)
                        {
                            ...
                            BaseItems=new List<BaseItem>()
                            {
                                ...
                                new BaseItem("5","魚",6,3,true){CreateUserId = 1,CreateTime=DateTime.Now},
                                new BaseItem("6","鳥",7,3,true){CreateUserId = 1,CreateTime=DateTime.Now},
                                new BaseItem("7","獸",8,3,true){CreateUserId = 1,CreateTime=DateTime.Now},
